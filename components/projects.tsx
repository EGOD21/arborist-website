...
const projects: Project[] = [
  {
    ...
    category: "Clearing",
    description:
      "Widespread lot/brush clearing for both residential and commercial properties.",
    image:
  ...
  },
  {
    ...
    images: [
      "/storm-damage-7361.jpg",
      "/storm-damage-7362.jpg",
      "/storm-damage-7916.jpg",
      "/storm-damage-7919.jpg",
      "/storm-damage-7920.jpg"
    ],
  },
  {
  ...
  },
  {
    ...
    category: "Commercial",
    description:
      "Large plot, commercial tree removal and clean-up.",
    image:
  ...
  },
  {
    ...
    images: [
      "/residential-7882.jpg",
      "/residential-7885.jpg", 
      "/residential-7887.jpg",
      "/residential-7888.jpg"
    ],
  },
  {
    title: "Land Clean-Up",
    category: "Clean-Up",
    description:
      "Careful trimming and removal of land plots, including bushes, trees, and grass (not mowing).",
    image:
        ...
        <DialogContent className="max-w-4xl w-[90vw]">
          {selectedProject !== null && (
            <>
              ...
              {/* Image Carousel for Storm Damage Recovery */}
