...
const services = [
  ...
  },
  {
    ...
    title: "Tree Planting",
    description: "Selection and planting of appropriate tree species for your location and soil conditions.",
  },
  {
    icon: <AlertTriangle className="h-10 w-10 text-green-700" />,
    title: "Emergency Services",
    description: "24/7 response for storm damage and hazardous tree situations.",
  },
  {
    icon: <Sprout className="h-10 w-10 text-green-700" />,
    title: "Tree Health Care",
    description: "Diagnosis and treatment of tree diseases and pest infestations.",
  },
  {
    icon: <Ruler className="h-10 w-10 text-green-700" />,
    title: "Tree Assessment",
    description: "Professional evaluation of tree health, structure, and potential risks.",
  },
]
