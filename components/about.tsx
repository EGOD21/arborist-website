        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[500px] overflow-hidden rounded-lg shadow-xl">
            <motion.div style={{ y: y1, opacity }} className="absolute inset-0">
              <Image src="/placeholder.svg?height=600&width=800" alt="Arborist at work" fill className="object-cover" />
            </motion.div>
            <motion.div
              style={{ y: y2, opacity }}
          ...
          {/* Content Column */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">About Arbor Experts</h2>
            <div className="w-20 h-1 bg-green-700 mb-8"></div>

            <p className="text-gray-700 mb-6 text-lg">
              With over 15 years of experience in the arboriculture industry, Arbor Experts has been providing
              exceptional tree care services to residential and commercial properties throughout the region.
            </p>

            <p className="text-gray-700 mb-8 text-lg">
              Our team of certified arborists combines scientific knowledge with practical expertise to deliver
              solutions that maintain the health and beauty of your trees while ensuring the safety of your property.
            </p>
