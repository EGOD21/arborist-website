    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        <Link href="/" className="flex items-center">
          <Image
            src="https://cdn.builder.io/api/v1/image/assets%2Fb11935c5315c460ba00f1e3a1c6658c4%2F553da30ee12a45bfa42ac21de9cc7b7c"
        ...
        <div className="md:hidden flex items-center gap-2">
          <Button
            onClick={() => scrollToSection("contact")}
            className="bg-green-700 hover:bg-green-800 text-white text-sm px-3 py-1"
          >
            Book Now
          </Button>
          <Button
